...
object NetworkConfig {
    ...
    fun getRetrofit(): Retrofit {
        return Retrofit.Builder()
            .baseUrl("http://192.168.1.17/server_api/index.php/ServerApi/")
    ...
    interface StaffService{
        ...
        fun addStaff(@Field("name") name: String,
                ...
                @Field("namdos") namdos: String) : Call<ResulrStatus>
        ...
        @FormUrlEncoded
        @POST("deleteStaff")
        abstract fun deleteStaff(@Field("id") id: String?): Call<ResulrStatus>
    }